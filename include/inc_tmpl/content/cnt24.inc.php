   ...
   function sendRequestCat() {
        new Ajax("include/inc_act/ajax_cnt24.php", {
            ...
            onComplete: function(text) {
                if(this.options.data.idstruct==0) {
                    $("cont_cps").innerHTML = "";
                    $('calias').value = "";
                }
...
<tr><td colspan="2"><img src="img/leer.gif" width="1" height="3" alt=""></td></tr>
<tr>
  <td align="right" valign="top" class="chatlist"><?php echo $BL['be_ctype']; ?>&nbsp;</td>
  <td><div id="cont_cps" style="padding:3px;border: 1px solid #CDCDCD;min-height:20px;">&nbsp;</div>
<script type="text/javascript">
sendRequestArt();
</script></td>
</tr>
